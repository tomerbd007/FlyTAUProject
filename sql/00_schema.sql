-- FlyTAU Database Schema
-- Generated from MySQL Workbench, Dec 30 2025
...
-- Flights table - stores flight duration in minutes
...
-- Note: We enforce 'one seat per flight' in the app code (order_repository.py)
-- instead of a DB trigger - gives us better error messages and transaction control.
